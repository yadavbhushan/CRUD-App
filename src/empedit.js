...
export default function Empedit(){
    ...
    const[Roll_No,rollchange]=useState("");
    ...
    useEffect(()=>{
        ...
        e.preventDefault();
        const empdata = {id,name,Roll_No,email,phone}
                    ...
                    <div className='container'>
                            ...
                            <div className='col-lg-12'>
                                <div className='form-group'>
                                    ...
                                    <input type='number' value={Roll_No} onChange={e=>rollchange(e.target.value)} className='form-control' required></input>
                                </div>
                            </div>
                            <div className='col-lg-12'>
                                <div className='form-group'>
